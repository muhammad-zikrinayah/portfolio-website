...
import { TextHeadingSmall } from "./CustomText";
...
export function ModalSkill({ isOpen, onClose, title, children }) {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed inset-0 z-[1000] flex items-center justify-center bg-neutral-900/30"
        ...
        <div className="p-24 gap-y-16 flex flex-col">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={onClose}
            >
              <CustomIcons icon="fi-FiX" iconColor="" iconSize="20" />
            </button>
          </div>
